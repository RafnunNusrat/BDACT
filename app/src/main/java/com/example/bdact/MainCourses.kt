    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNav.setOnItemSelectedListener {
            when(it.itemId) {
                ...
                R.id.message -> {
                    Toast.makeText(this@MainCourses, "Call for any infomation", Toast.LENGTH_LONG).show()
        ...
        val button147 = findViewById<Button>(R.id.btn147)
        button147.setOnClickListener {
